...
class TestTaxCalculator(unittest.TestCase):
    ...
    def test_net_income_class_1_medium_income(self):
        ...
        result = calculate_net_income(50000, tax_class=1)
    ...
    def test_net_income_class_3_medium_income(self):
        ...
        result = calculate_net_income(50000, tax_class=3)
    ...
    def test_net_income_high_income_soli(self):
        ...
        result = calculate_net_income(100000, tax_class=1)
    ...
    def test_net_income_church_tax(self):
        ...
        result = calculate_net_income(50000, tax_class=1, in_church=True)
    ...
    def test_net_income_low_income(self):
        ...
        result = calculate_net_income(15000, tax_class=1)
    ...
    def test_net_income_ss_ceiling(self):
        ...
        result = calculate_net_income(120000, tax_class=1)
